...
function glavnaFunkcija(m) {
    ...
    if (m == 1) {
        document.getElementById("slikaZaIgraca").style.backgroundImage = "url(kamen.jpg)";
        if (randomBroj == 1) {
            document.getElementById("slikaZaKompijutera").style.backgroundImage = "url(rock.jpg)";
            brojacNerijesenih += 1;
            ...
            document.getElementById("slikaZaKompijutera").style.backgroundImage = "url(paper.jpg)";
            ...
            document.getElementById("slikaZaKompijutera").style.backgroundImage = "url(scissors.jpg)";
        ...
        document.getElementById("slikaZaIgraca").style.backgroundImage = "url(papir.jpg)";
        if (randomBroj == 1) {
            document.getElementById("slikaZaKompijutera").style.backgroundImage = "url(rock.jpg)";
            brojacRezultataIgraca += 1;
            document.getElementById("youu").innerHTML = brojacRezultataIgraca;
        ...
        document.getElementById("slikaZaIgraca").style.backgroundImage = "url(makaze.jpg)";
        if (randomBroj == 1) {
            document.getElementById("slikaZaKompijutera").style.backgroundImage = "url(rock.jpg)";
            brojacRezultataKompa += 1;
            document.getElementById("compp").innerHTML = brojacRezultataKompa;
...
function sakrijKont() {
    if (otvoreno == true) {
        document.getElementById("opcijeIPostavke").style.maxHeight = "0" + "px";
        otvoreno = false;
    }
    else if (otvoreno == false) {
        document.getElementById("opcijeIPostavke").style.maxHeight = "unset";
        otvoreno = true;
    }
}
